...
"}")
        icon5 = QIcon()
        icon5.addFile(u":/prefijoNuevo/column-chart-line-icon.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.reporte_2.setIcon(icon5)
        self.reporte_2.setIconSize(QSize(100, 20))
        self.reporte_2.setCheckable(True)
        self.reporte_2.setAutoExclusive(True)

        self.verticalLayout_2.addWidget(self.reporte_2)
...
"}")
        icon6 = QIcon()
        icon6.addFile(u":/prefijoNuevo/log-out.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_rol_2.setText(QCoreApplication.translate("MainWindow", u"Bienvenido a la aplicacion de Usuario", None))
